...
// LOCAL DEV: build sing-box_mod standalone against the sing-anytls 0.0.13 fork.
// Assumes sibling layout <parent>/{sing-box_mod, sing-anytls}.
// (Ignored when sing-box_mod is a dependency of V2bX — that build uses V2bX's own replace.)
